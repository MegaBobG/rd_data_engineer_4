...
def transform_data_csv():
    sales = pd.read_csv(f"{dag_path}/processed_data/CSV/sales_2022-08-09.csv", low_memory=False)
...
#     op_kwargs={"json_file_path": os.path.join(RAW_DIR_2, "sales_2022-08-09.json"),
#                "avro_file_path": os.path.join(STG_DIR_2, "sales_2022-08-09.avro"), "schema": AVRO_SCHEMA},
#     dag=dag
# )
